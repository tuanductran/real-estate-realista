 ...
 */
return array(
	'title'      => __( 'Footer with text, title, and logo', 'real-estate-realista' ),
	...
	'content'    => '<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"var(--wp--custom--spacing--large, 8rem)","bottom":"6rem"}}},"backgroundColor":"secondary","layout":{"inherit":true}} -->
					...
					<p style="text-transform:uppercase">' . esc_html__( 'About us', 'real-estate-realista' ) . '</p>
					<!-- /wp:paragraph -->

					<!-- wp:paragraph {"style":{"fontSize":"small"} -->
					<p class="has-small-font-size">' . esc_html__( 'We are a rogue collective of bird watchers. We’ve been known to sneak through fences, climb perimeter walls, and generally trespass in order to observe the rarest of birds.', 'real-estate-realista' ) . '</p>
					<!-- /wp:paragraph -->
