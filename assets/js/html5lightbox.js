        ...
        $.fn.html5lightbox = function (options) {
            ...
            inst.createMarkup = function () {
                ...
                if (inst.options.showsocial) {
                    ...
                    $(".html5-social-btn", inst.$lightbox).on('click', function () {
                ...
                if (inst.options.fullscreenmode) {
                    ...
                    inst.$nextbottom.on('click', function () {
                        inst.nextArrowClicked();
                    });
                    inst.$prevbottom.on('click', function () {
                    ...
                    if ((inst.options.isTouch && inst.options.navarrowsalwaysshowontouch) || inst.options.alwaysshownavarrows) {
                        ...
                        inst.$nexttouch.on('click', function () {
                            inst.nextArrowClicked();
                        });
                        inst.$prevtouch.on('click', function () {
                            inst.prevArrowClicked();
                        });
                    }
                    inst.$lightboxBox.append(
                        "<div id='html5-close' style='display:none;cursor:pointer;position:absolute;top:0;right:0;margin-top:-16px;margin-right:-16px;'><img src='" + inst.options.skinsfolder + inst.options.closeimage + "'></div>"
                    );
                ...
                inst.$next.on('click', function () {
                    inst.nextArrowClicked();
                });
                inst.$prev.on('click', function () {
                    inst.prevArrowClicked();
                });
            ...
            inst.showNavigation = function () {
                ...
                $(".html5-nav-thumb").on('click', function () {
            ...
            (inst.showTitle = function (w, t, description) {
                ...
                if (inst.options.inGroup && inst.options.showplaybutton) {
                    ...
                    $("#html5-play", inst.$lightbox).on('click', function () {
                        $("#html5-play", inst.$lightbox).hide();
                        $("#html5-pause", inst.$lightbox).show();
                    ...
                    $("#html5-pause", inst.$lightbox).on('click', function () {
                        $("#html5-play", inst.$lightbox).show();
                        $("#html5-pause", inst.$lightbox).hide();
                        if (inst.slideTimeout) {
                            inst.slideTimeout.stop();
